...
SELECT
  ...
  3,
  '["AI", "machine learning", "deep learning", "neural networks"]'::jsonb,
  '["cs.AI", "cs.LG", "cs.CL", "cs.CV"]'::jsonb,
  7.0,
  'ACTIVE',
  true,
...
SELECT
  ...
  60,
  '["AI", "Google", "research", "machine learning"]'::jsonb,
  8.0,
  'ACTIVE',
  true,
  '{"checkUrl": true, "checkTitle": true, "titleSimilarityThreshold": 0.85}'::jsonb,
...
SELECT
  ...
  60,
  '["AI", "OpenAI", "GPT", "ChatGPT", "research"]'::jsonb,
  9.0,
  'ACTIVE',
  true,
  '{"checkUrl": true, "checkTitle": true, "titleSimilarityThreshold": 0.85}'::jsonb,
