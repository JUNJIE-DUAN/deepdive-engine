import { Controller, Get, Post, Param, Query, Logger, ParseIntPipe, DefaultValuePipe } from '@nestjs/common';
...
export class KnowledgeGraphController {
  ...
  async getResourceGraph(
    ...
    this.logger.log(`Fetching knowledge graph for resource ${id} (depth: ${depth})`);
