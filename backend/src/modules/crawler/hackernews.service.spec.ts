...
describe("HackernewsService", () => {
  ...
  beforeEach(async () => {
    ...
    const mockCommentsService = {
      fetchCommentsByStoryId: jest.fn(),
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: HackernewsCommentsService,
  ...
  describe.skip("fetchTopStories (TODO: fix mock setup)", () => {
    it("应该成功获取热门故事", async () => {
      // 模拟API响应
  ...
  describe.skip("fetchNewStories (TODO: fix mock setup)", () => {
    it("应该成功获取最新故事", async () => {
      mockedAxios.get.mockResolvedValueOnce({
        data: mockStoryIds,
      });
  ...
  describe.skip("fetchBestStories (TODO: fix mock setup)", () => {
    it("应该成功获取最佳故事", async () => {
      mockedAxios.get.mockResolvedValueOnce({
        data: mockStoryIds,
      });
  ...
  describe.skip("错误处理 (TODO: fix mock setup)", () => {
  ...
  describe.skip("数据完整性 (TODO: fix mock setup)", () => {
