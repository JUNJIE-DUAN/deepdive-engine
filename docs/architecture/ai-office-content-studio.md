...
| 层次           | 技术选型                      | 理由                       |
| -------------- | ----------------------------- | -------------------------- |
| **框架**       | NestJS                        | 模块化、TypeScript、企业级 |
| **数据库**     | PostgreSQL                    | 关系型数据 + JSONB 支持    |
| **向量数据库** | Gemini File Search (托管)     | 零运维、高性能             |
| **文件存储**   | AWS S3 / Google Cloud Storage | 大文件存储                 |
