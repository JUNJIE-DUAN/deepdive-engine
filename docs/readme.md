...
### Q: 找不到某个功能的文档？
A: 1. 检查本README的功能文档部分
   2. 使用文件搜索（Ctrl+P）查找关键词
   3. 查看归档目录是否有历史版本
...
### Q: 部署时遇到问题怎么办？
A: 1. 查看 [guides/deployment.md](guides/deployment.md)
   2. 检查 [guides/access.md](guides/access.md) 确认服务状态
   3. 参考项目根目录的 README.md
