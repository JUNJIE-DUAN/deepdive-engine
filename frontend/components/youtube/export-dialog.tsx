    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-blue-700">
          <h2 className="text-xl font-semibold text-white">Export Subtitles to PDF</h2>
        </div>
        ...
        <div className="px-6 py-4 space-y-6">
            ...
            <div className="space-y-2">
              <label className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-900">Bilingual (Side by Side)</div>
                  <div className="text-xs text-gray-500">English and Chinese in parallel columns</div>
                </div>
              </label>
              ...
              <label className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-900">Bilingual (Stacked)</div>
                  <div className="text-xs text-gray-500">English and Chinese one after another</div>
                </div>
              </label>
              ...
              <label className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-900">English Only</div>
                  <div className="text-xs text-gray-500">Only English subtitles</div>
                </div>
              </label>
              ...
              <label className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-900">Chinese Only</div>
                  <div className="text-xs text-gray-500">Only Chinese subtitles</div>
                </div>
              </label>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
              ...
              />
              <div className="flex-1">
                <div className="text-sm font-medium text-gray-900">Include Timestamps</div>
                <div className="text-xs text-gray-500">Show time markers for each subtitle</div>
              </div>
            </label>
            ...
            <label className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
              <input
                ...
                onChange={(e) => setOptions({ ...options, includeVideoUrl: e.target.checked })}
                className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
              />
              <div className="flex-1">
                <div className="text-sm font-medium text-gray-900">Include Video URL</div>
                <div className="text-xs text-gray-500">Add YouTube video link in header</div>
              </div>
            </label>
            ...
            <label className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-gray-500">Show video title and export date</div>
              </div>
            </label>
          </div>
        </div>
