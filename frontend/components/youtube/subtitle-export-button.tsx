...
import { useYoutubeSubtitleExport, BilingualSubtitles, ExportOptions } from '@/hooks/useYoutubeSubtitleExport';
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg shadow-lg p-4">
            ...
            {fetchError && (
              <button
                ...
                className="mt-3 w-full px-3 py-2 text-xs font-medium text-red-700 bg-red-100 rounded hover:bg-red-200 transition-colors"
              >
                Retry
              </button>
            )}
      ...
      {isLoading && !isDialogOpen && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-30">
          <div className="bg-white rounded-lg shadow-xl p-6 flex items-center space-x-4">
            ...
            <span className="text-gray-700 font-medium">Loading subtitles...</span>
          </div>
        </div>
      )}
    </>
